	...
	public static void main(String[] args) {
		// TODO Auto-generated method stub
		 WebDriverManager.chromedriver().setup();
	        ...
	        WebElement dupform = driver.findElement(By.linkText("Duplicate Lead"));
	        dupform.click();
	        
	        WebElement leadform1 = driver.findElement(By.id("createLeadForm_companyName"));
	        leadform1.clear();
	        leadform1.sendKeys("ThoughWorks");
	        
	        WebElement fname1 = driver.findElement(By.id("createLeadForm_firstName"));
	        fname1.clear();
	        fname1.sendKeys("Gokulasthe");
	        
	        WebElement leadcreated1 = driver.findElement(By.className("smallSubmit"));
	        leadcreated1.click();
	        
	        String titlepage1 = driver.getTitle();
	        System.out.println(titlepage1);
	        if(driver.getTitle().contains("opentaps")) {
	        	System.out.println("Form re-created successfully");
	        }
	        else {
	        	System.out.println("Form re-creation failed");
	        }    
  }
